...
namespace Touba.WebApis.Api.Controllers
{
    ...
    public class ExcessCapacityController : ControllerBase
    {
        private readonly DataContext _context;
        private readonly ILogger logger;

        public ExcessCapacityController(DataContext context)
        {
            _context = context;
        }

        // GET: api/ExcessCapacity
        [HttpGet]
